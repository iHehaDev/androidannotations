 ...
 * the License.
 */
package org.androidannotations.hehaguice.annotations;
 ...
 * &#064;FluxStore({ AstroListener.class, AnotherListener.class })
...
public @interface FluxStore {
	/**
	 * The FluxStore listener classes to bind to this activity. Will add an
	 * injected listener field to the subclass.
	 * 
	 * @return the FluxStore listener classes
	 */
	Class<?>[] value() default {};
}
